 ...
 */
final class Version20260427131331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projects DROP thumbnail_file');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projects ADD thumbnail_file VARCHAR(255) DEFAULT NULL');
    }
}
