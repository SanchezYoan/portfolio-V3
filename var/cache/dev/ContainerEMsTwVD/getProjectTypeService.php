...
class getProjectTypeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/FormListenerFactory.php';

        return $container->privates['App\\Form\\ProjectType'] = new \App\Form\ProjectType(new \App\Service\FormListenerFactory());
    }
}
