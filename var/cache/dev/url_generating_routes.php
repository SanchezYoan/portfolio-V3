...
return [
    ...
    'about.show' => [[], ['_controller' => 'App\\Controller\\AboutController::index'], [], [['text', '/about']], [], [], []],
    'admin.home' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::home'], [], [['text', '/admin/']], [], [], []],
    'admin.project.index' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::projectIndex'], [], [['text', '/admin/project']], [], [], []],
    'admin.project.show' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/admin/project']], [], [], []],
    'admin.project.new' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::new'], [], [['text', '/admin/project/new']], [], [], []],
    'admin.project.edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::edit'], ['id' => '[0-9]+'], [['text', '/edit'], ['variable', '/', '[0-9]+', 'id', true], ['text', '/admin/project']], [], [], []],
    'admin.project.delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::delete'], ['id' => '[0-9]+'], [['text', '/delete'], ['variable', '/', '[0-9]+', 'id', true], ['text', '/admin/project']], [], [], []],
    ...
    'security.register' => [[], ['_controller' => 'App\\Controller\\RegistrationController::register'], [], [['text', '/register']], [], [], []],
    'security.verify_email' => [[], ['_controller' => 'App\\Controller\\RegistrationController::verifyUserEmail'], [], [['text', '/verify/email']], [], [], []],
    ...
    'App\Controller\Admin\AdminProjectController::new' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::new'], [], [['text', '/admin/project/new']], [], [], []],
    'App\Controller\Admin\AdminProjectController::edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::edit'], ['id' => '[0-9]+'], [['text', '/edit'], ['variable', '/', '[0-9]+', 'id', true], ['text', '/admin/project']], [], [], []],
    'App\Controller\Admin\AdminProjectController::delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminProjectController::delete'], ['id' => '[0-9]+'], [['text', '/delete'], ['variable', '/', '[0-9]+', 'id', true], ['text', '/admin/project']], [], [], []],
