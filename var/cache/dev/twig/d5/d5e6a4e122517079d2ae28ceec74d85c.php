...
class __TwigTemplate_679972713c4af134c56bf268ddc62fc8 extends Template
{
    ...
    <div class=\"container\">
        ...
        // line 16
        yield "                ";
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 16, $this->source); })()), 'form');
        yield "
            ";
        // line 18
        yield "        </div>
...
";
    ...
    {
        return array (  130 => 18,  125 => 16,  120 => 13,  114 => 9,  105 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/Users/sanchezyoan/Documents/dev/portfolio-V3/templates/registration/register.html.twig");
    }
}
